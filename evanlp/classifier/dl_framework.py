...
from evanlp.ai_toolkit.preprocess import embed
from evanlp.ai_toolkit.evaluation import f1_score
from evanlp.ai_toolkit.hyperparameter_optimizer import cyclic_learning_rate\
    as clr
...
class Instance(object):
    ...
    def data_cv_split(predictor, tv_rate, v_t_rate):
        from evanlp.classifer_visualization import visualizer
